...
PICS = (environ.get('PICS', 'https://envs.sh/ifA.jpg https://envs.sh/b25.jpg https://envs.sh/b2G.jpg https://envs.sh/b2z.jpg https://envs.sh/b2K.jpg https://envs.sh/b23.jpg https://envs.sh/b2C.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://envs.sh/if_.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://files.catbox.moe/095ie9.mp4")
SPELL_IMG = environ.get("SPELL_IMG", "https://files.catbox.moe/jzz1os.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://files.catbox.moe/iida7a.jpg'))
FSUB_PICS = (environ.get('FSUB_PICS', 'https://envs.sh/ifj.jpg')).split()  # Fsub pic

# ============================
# Admin, Channels & Users Configuration
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1324630114').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002756427466').split()]  # Channel id for auto indexing (make sure bot is admin)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002546287361'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002848411735'))  # Bin channel id (make sure bot is admin)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002756427466'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002546287361'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1002682128156')  # Channel/Group ID for force sub (make sure bot is admin)
...
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002682128156').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-4840392045').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
...
#Auto approve 
CHAT_ID = [int(app_chat_id) if id_pattern.search(app_chat_id) else app_chat_id for app_chat_id in environ.get('CHAT_ID', '1324630114').split()]
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+WLpFwcXq9C42MzI9')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+-mQfm_FEeHphOWE9')
OWNER_LNK = environ.get('OWNER_LNK', '@Sree_Hari_123')
MOVIE_UPDATE_CHANNEL_LNK = environ.get('MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/+-mQfm_FEeHphOWE9')
OWNERID = int(os.environ.get('OWNERID', '1324630114'))  # Replace with the actual admin ID
...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '1324630114').split()]
